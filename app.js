...
// ==================== 火宝宝 7 级进化 ====================
// 通用 defs：渐变受 .stop-mid（绑 --huo-color）控制等级色
function flameSvg(lv) {
  ...
  const defs = `
    ...
    <linearGradient id="hbFlameG" x1="0" y1="1" x2="0" y2="0">
      <stop offset="0%" stop-color="#ff5e3a"/>
      <stop offset="50%" stop-color="#ff8a00"/>
      <stop offset="100%" stop-color="#ffd166"/>
    </linearGradient>
    <linearGradient id="hbWingG" x1="0" y1="1" x2="0.5" y2="0">
      <stop offset="0%" stop-color="#ff5e3a"/>
      <stop offset="60%" stop-color="#ff8a00"/>
      <stop offset="100%" stop-color="#ffd166"/>
    </linearGradient>
    <radialGradient id="hbGoldAura" cx="50%" cy="50%" r="50%">
      <stop offset="60%" stop-color="#ffd700" stop-opacity="0"/>
      <stop offset="85%" stop-color="#ffd700" stop-opacity="0.7"/>
      <stop offset="100%" stop-color="#ffae00" stop-opacity="0"/>
    </radialGradient>
  `;
  // 通用脸部
  const face = `
    <ellipse cx="85" cy="92" rx="24" ry="32" fill="url(#hbShine)"/>
    <g class="hb-eye hb-eye-l">
      <circle cx="80" cy="120" r="13" fill="#fff"/>
      <circle cx="83" cy="123" r="7.5" fill="#3a2410"/>
      <circle cx="79" cy="119" r="3.2" fill="#fff"/>
    </g>
    <g class="hb-eye hb-eye-r">
      <circle cx="120" cy="120" r="13" fill="#fff"/>
      <circle cx="117" cy="123" r="7.5" fill="#3a2410"/>
      <circle cx="115" cy="119" r="3.2" fill="#fff"/>
    </g>
    <ellipse cx="64" cy="146" rx="8" ry="4.5" fill="#ff7a8a" opacity="0.6"/>
    <ellipse cx="136" cy="146" rx="8" ry="4.5" fill="#ff7a8a" opacity="0.6"/>
    <path d="M88 145 Q100 162 112 145 Z" fill="#7a2e16"/>
    <path d="M93 152 Q100 158 107 152 Z" fill="#ff8a9a"/>
  `;

  if (lv === 1) {
    // Lv.1 小火苗：圆球 + 顶部小火焰
    return `<svg class="hb-flame hb-lv1" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <defs>${defs}</defs>
      <g class="hb-body">
        <path d="M100 30 C 118 58, 110 75, 100 78 C 90 75, 82 58, 100 30 Z" fill="url(#hbFlameG)"/>
        <ellipse cx="100" cy="125" rx="55" ry="60" fill="url(#hbGrad)"/>
        ${face}
      </g>
    </svg>`;
  }
  ...
  if (lv === 2) {
    // Lv.2 跳跳火：圆球 + 短手短脚
    return `<svg class="hb-flame hb-lv2" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <defs>${defs}</defs>
      <g class="hb-body">
        <path d="M100 22 C 122 55, 112 75, 100 78 C 88 75, 78 55, 100 22 Z" fill="url(#hbFlameG)"/>
        <path d="M100 8 C 110 25, 106 35, 100 36 C 94 35, 90 25, 100 8 Z" fill="#ffd166" opacity="0.85"/>
        <ellipse cx="100" cy="122" rx="58" ry="62" fill="url(#hbGrad)"/>
        <circle class="hb-hand hb-hand-left" cx="42" cy="135" r="13" fill="#ff7b00" stroke="#ffd166" stroke-width="2"/>
        <circle class="hb-hand hb-hand-right" cx="158" cy="135" r="13" fill="#ff7b00" stroke="#ffd166" stroke-width="2"/>
        <ellipse cx="80" cy="180" rx="15" ry="9" fill="#ff5e3a"/>
        <ellipse cx="120" cy="180" rx="15" ry="9" fill="#ff5e3a"/>
        ${face}
      </g>
    </svg>`;
  }
  ...
  if (lv === 3) {
    // Lv.3 烈焰宝宝：双角 + 尾巴小火焰 + 利爪手脚
    return `<svg class="hb-flame hb-lv3" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <defs>${defs}</defs>
      <g class="hb-body">
        <!-- 尾巴火焰 -->
        <path d="M165 150 Q 188 130, 184 105 Q 175 115, 170 130 Q 168 145, 165 150 Z" fill="url(#hbFlameG)"/>
        <!-- 角 -->
        <path d="M76 72 Q 70 50, 60 42 Q 72 50, 82 68 Z" fill="#ff5e3a"/>
        <path d="M124 72 Q 130 50, 140 42 Q 128 50, 118 68 Z" fill="#ff5e3a"/>
        <!-- 顶火焰 -->
        <path d="M100 14 C 120 50, 110 72, 100 76 C 90 72, 80 50, 100 14 Z" fill="url(#hbFlameG)"/>
        <path d="M100 2 C 108 18, 105 26, 100 28 C 95 26, 92 18, 100 2 Z" fill="#ffd166" opacity="0.9"/>
        <!-- 身体 -->
        <ellipse cx="100" cy="125" rx="58" ry="62" fill="url(#hbGrad)"/>
        <!-- 利爪手 -->
        <path class="hb-hand hb-hand-left" d="M30 130 Q 18 142, 22 158 Q 32 158, 42 152 Q 50 146, 48 134 Z" fill="#ff7b00" stroke="#ffd166" stroke-width="2"/>
        <path class="hb-hand hb-hand-right" d="M170 130 Q 182 142, 178 158 Q 168 158, 158 152 Q 150 146, 152 134 Z" fill="#ff7b00" stroke="#ffd166" stroke-width="2"/>
        <!-- 利爪脚 -->
        <path d="M70 178 Q 65 192, 80 192 Q 92 192, 90 178 Z" fill="#ff5e3a"/>
        <path d="M130 178 Q 135 192, 120 192 Q 108 192, 110 178 Z" fill="#ff5e3a"/>
        ${face}
      </g>
    </svg>`;
  }
  ...
  if (lv === 4) {
    // Lv.4 炽焰精灵：双翼 + 更大火焰 + 强化角
    return `<svg class="hb-flame hb-lv4" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <defs>${defs}</defs>
      <g class="hb-body">
        <!-- 左翼 -->
        <path d="M40 110 Q 4 70, 12 110 Q 6 130, 30 142 Q 38 130, 40 110 Z" fill="url(#hbWingG)"/>
        <!-- 右翼 -->
        <path d="M160 110 Q 196 70, 188 110 Q 194 130, 170 142 Q 162 130, 160 110 Z" fill="url(#hbWingG)"/>
        <!-- 尾巴火焰 -->
        <path d="M170 160 Q 196 140, 190 112 Q 180 122, 174 138 Q 172 152, 170 160 Z" fill="url(#hbFlameG)"/>
        <!-- 角 -->
        <path d="M72 68 Q 62 38, 50 28 Q 66 42, 80 66 Z" fill="#ff5e3a"/>
        <path d="M128 68 Q 138 38, 150 28 Q 134 42, 120 66 Z" fill="#ff5e3a"/>
        <!-- 顶火焰 -->
        <path d="M100 8 C 124 48, 112 75, 100 80 C 88 75, 76 48, 100 8 Z" fill="url(#hbFlameG)"/>
        <path d="M100 -2 C 109 16, 106 26, 100 28 C 94 26, 91 16, 100 -2 Z" fill="#ffd166" opacity="0.9"/>
        <!-- 身体 -->
        <ellipse cx="100" cy="122" rx="60" ry="65" fill="url(#hbGrad)"/>
        <!-- 利爪手 -->
        <path class="hb-hand hb-hand-left" d="M24 132 Q 12 146, 18 162 Q 30 162, 42 154 Q 50 146, 48 134 Z" fill="#ff7b00" stroke="#ffd166" stroke-width="2"/>
        <path class="hb-hand hb-hand-right" d="M176 132 Q 188 146, 182 162 Q 170 162, 158 154 Q 150 146, 152 134 Z" fill="#ff7b00" stroke="#ffd166" stroke-width="2"/>
        <!-- 利爪脚 -->
        <path d="M68 180 Q 62 194, 78 196 Q 92 194, 90 180 Z" fill="#ff5e3a"/>
        <path d="M132 180 Q 138 194, 122 196 Q 108 194, 110 180 Z" fill="#ff5e3a"/>
        ${face}
      </g>
    </svg>`;
  }
  ...
  if (lv === 5) {
    // Lv.5 炎龙之魂：更大双翼 + 身体周围火苗 + 强化角
    return `<svg class="hb-flame hb-lv5" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <defs>${defs}</defs>
      <g class="hb-body">
        <!-- 左翼（更大） -->
        <path d="M38 108 Q 0 60, 8 108 Q 2 135, 30 150 Q 38 130, 38 108 Z" fill="url(#hbWingG)"/>
        <path d="M22 92 Q 8 78, 14 96 Q 18 86, 22 92 Z" fill="#ffd166" opacity="0.85"/>
        <!-- 右翼 -->
        <path d="M162 108 Q 200 60, 192 108 Q 198 135, 170 150 Q 162 130, 162 108 Z" fill="url(#hbWingG)"/>
        <path d="M178 92 Q 192 78, 186 96 Q 182 86, 178 92 Z" fill="#ffd166" opacity="0.85"/>
        <!-- 尾巴火焰（更长） -->
        <path d="M172 165 Q 200 142, 194 108 Q 182 122, 176 142 Q 174 156, 172 165 Z" fill="url(#hbFlameG)"/>
        <path d="M180 145 Q 196 132, 192 116 Q 184 128, 180 140 Z" fill="#ffd166" opacity="0.85"/>
        <!-- 角（更长更尖） -->
        <path d="M70 65 Q 56 30, 42 18 Q 62 36, 80 62 Z" fill="#ff5e3a"/>
        <path d="M130 65 Q 144 30, 158 18 Q 138 36, 120 62 Z" fill="#ff5e3a"/>
        <!-- 顶火焰（更大） -->
        <path d="M100 2 C 128 42, 114 72, 100 78 C 86 72, 72 42, 100 2 Z" fill="url(#hbFlameG)"/>
        <path d="M100 -8 C 110 10, 107 22, 100 24 C 93 22, 90 10, 100 -8 Z" fill="#ffd166" opacity="0.9"/>
        <!-- 身体周围火苗 -->
        <path d="M48 130 Q 38 140, 46 152 Q 52 144, 48 130 Z" fill="url(#hbFlameG)" opacity="0.9"/>
        <path d="M152 130 Q 162 140, 154 152 Q 148 144, 152 130 Z" fill="url(#hbFlameG)" opacity="0.9"/>
        <!-- 身体 -->
        <ellipse cx="100" cy="122" rx="62" ry="66" fill="url(#hbGrad)"/>
        <!-- 利爪手 -->
        <path class="hb-hand hb-hand-left" d="M22 132 Q 8 148, 16 166 Q 30 166, 44 156 Q 52 146, 50 134 Z" fill="#ff7b00" stroke="#ffd166" stroke-width="2"/>
        <path class="hb-hand hb-hand-right" d="M178 132 Q 192 148, 184 166 Q 170 166, 156 156 Q 148 146, 150 134 Z" fill="#ff7b00" stroke="#ffd166" stroke-width="2"/>
        <!-- 利爪脚 -->
        <path d="M66 180 Q 58 196, 76 198 Q 92 196, 90 180 Z" fill="#ff5e3a"/>
        <path d="M134 180 Q 142 196, 124 198 Q 108 196, 110 180 Z" fill="#ff5e3a"/>
        ${face}
      </g>
    </svg>`;
  }
  ...
  if (lv === 6) {
    // Lv.6 不灭圣火：站立姿态 + 巨大双翼 + 长角
    return `<svg class="hb-flame hb-lv6" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <defs>${defs}</defs>
      <g class="hb-body">
        <!-- 大双翼（展开） -->
        <path d="M36 105 Q -4 50, 4 102 Q -2 138, 26 156 Q 36 130, 36 105 Z" fill="url(#hbWingG)"/>
        <path d="M20 88 Q 4 70, 10 92 Q 14 80, 20 88 Z" fill="#ffd166" opacity="0.9"/>
        <path d="M164 105 Q 204 50, 196 102 Q 202 138, 174 156 Q 164 130, 164 105 Z" fill="url(#hbWingG)"/>
        <path d="M180 88 Q 196 70, 190 92 Q 186 80, 180 88 Z" fill="#ffd166" opacity="0.9"/>
        <!-- 长尾巴火焰 -->
        <path d="M170 170 Q 200 145, 196 110 Q 184 125, 178 145 Q 174 160, 170 170 Z" fill="url(#hbFlameG)"/>
        <path d="M180 150 Q 200 135, 196 118 Q 186 130, 182 145 Z" fill="#ffd166" opacity="0.85"/>
        <!-- 长角 -->
        <path d="M68 60 Q 50 20, 36 8 Q 58 30, 78 56 Z" fill="#ff5e3a"/>
        <path d="M132 60 Q 150 20, 164 8 Q 142 30, 122 56 Z" fill="#ff5e3a"/>
        <!-- 顶火焰（更大更猛） -->
        <path d="M100 -4 C 132 38, 116 72, 100 78 C 84 72, 68 38, 100 -4 Z" fill="url(#hbFlameG)"/>
        <path d="M100 -14 C 110 6, 107 20, 100 22 C 93 20, 90 6, 100 -14 Z" fill="#ffd166" opacity="0.95"/>
        <!-- 身体周围飞舞火苗 -->
        <path d="M44 128 Q 32 138, 42 154 Q 50 144, 44 128 Z" fill="url(#hbFlameG)" opacity="0.9"/>
        <path d="M156 128 Q 168 138, 158 154 Q 150 144, 156 128 Z" fill="url(#hbFlameG)" opacity="0.9"/>
        <path d="M58 100 Q 50 110, 58 120 Q 62 112, 58 100 Z" fill="#ffd166" opacity="0.85"/>
        <path d="M142 100 Q 150 110, 142 120 Q 138 112, 142 100 Z" fill="#ffd166" opacity="0.85"/>
        <!-- 身体 -->
        <ellipse cx="100" cy="122" rx="64" ry="68" fill="url(#hbGrad)"/>
        <!-- 利爪手（更大） -->
        <path class="hb-hand hb-hand-left" d="M20 130 Q 4 148, 14 170 Q 30 168, 46 156 Q 54 146, 50 132 Z" fill="#ff7b00" stroke="#ffd166" stroke-width="2"/>
        <path class="hb-hand hb-hand-right" d="M180 130 Q 196 148, 186 170 Q 170 168, 154 156 Q 146 146, 150 132 Z" fill="#ff7b00" stroke="#ffd166" stroke-width="2"/>
        <!-- 利爪脚 -->
        <path d="M64 182 Q 54 198, 74 200 Q 92 198, 88 182 Z" fill="#ff5e3a"/>
        <path d="M136 182 Q 146 198, 126 200 Q 108 198, 112 182 Z" fill="#ff5e3a"/>
        ${face}
      </g>
    </svg>`;
  }

  // Lv.7 传说火神：神话级 - 巨大双翼 + 全身火海 + 金色光环（光环在 CSS 中由 .hb-mascot.hb-god-aura 渲染）
  return `<svg class="hb-flame hb-lv7" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <defs>${defs}</defs>
    <g class="hb-body">
      <!-- 巨大双翼（完全展开，遮天蔽日） -->
      <path d="M32 100 Q -10 40, 0 96 Q -6 140, 22 162 Q 34 132, 32 100 Z" fill="url(#hbWingG)"/>
      <path d="M14 82 Q -4 60, 4 86 Q 10 72, 14 82 Z" fill="#ffd166" opacity="0.95"/>
      <path d="M8 110 Q -8 96, -2 116 Q 4 110, 8 110 Z" fill="#ff8a00" opacity="0.9"/>
      <path d="M168 100 Q 210 40, 200 96 Q 206 140, 178 162 Q 166 132, 168 100 Z" fill="url(#hbWingG)"/>
      <path d="M186 82 Q 204 60, 196 86 Q 190 72, 186 82 Z" fill="#ffd166" opacity="0.95"/>
      <path d="M192 110 Q 208 96, 202 116 Q 196 110, 192 110 Z" fill="#ff8a00" opacity="0.9"/>
      <!-- 巨大尾巴火焰（带尾尖） -->
      <path d="M168 172 Q 204 145, 198 102 Q 186 122, 180 145 Q 174 162, 168 172 Z" fill="url(#hbFlameG)"/>
      <path d="M180 152 Q 204 134, 200 112 Q 188 128, 184 148 Z" fill="#ffd166" opacity="0.9"/>
      <path d="M188 130 Q 202 120, 198 108 Q 192 118, 188 130 Z" fill="#ff8a00" opacity="0.85"/>
      <!-- 最长最猛的角 -->
      <path d="M64 56 Q 42 8, 24 -4 Q 52 24, 76 50 Z" fill="#ff5e3a"/>
      <path d="M136 56 Q 158 8, 176 -4 Q 148 24, 124 50 Z" fill="#ff5e3a"/>
      <!-- 顶火焰（神级最盛） -->
      <path d="M100 -10 C 136 32, 118 72, 100 78 C 82 72, 64 32, 100 -10 Z" fill="url(#hbFlameG)"/>
      <path d="M100 -22 C 110 0, 107 14, 100 16 C 93 14, 90 0, 100 -22 Z" fill="#ffd166" opacity="0.95"/>
      <path d="M86 0 C 92 14, 90 22, 86 24 C 82 22, 80 14, 86 0 Z" fill="#ff8a00" opacity="0.85"/>
      <path d="M114 0 C 108 14, 110 22, 114 24 C 118 22, 120 14, 114 0 Z" fill="#ff8a00" opacity="0.85"/>
      <!-- 全身火苗飞舞 -->
      <path d="M40 122 Q 28 132, 38 150 Q 46 140, 40 122 Z" fill="url(#hbFlameG)" opacity="0.9"/>
      <path d="M160 122 Q 172 132, 162 150 Q 154 140, 160 122 Z" fill="url(#hbFlameG)" opacity="0.9"/>
      <path d="M52 92 Q 44 102, 52 114 Q 56 104, 52 92 Z" fill="#ffd166" opacity="0.85"/>
      <path d="M148 92 Q 156 102, 148 114 Q 144 104, 148 92 Z" fill="#ffd166" opacity="0.85"/>
      <path d="M40 158 Q 30 168, 40 180 Q 46 168, 40 158 Z" fill="#ff8a00" opacity="0.8"/>
      <path d="M160 158 Q 170 168, 160 180 Q 154 168, 160 158 Z" fill="#ff8a00" opacity="0.8"/>
      <!-- 身体 -->
      <ellipse cx="100" cy="122" rx="66" ry="70" fill="url(#hbGrad)"/>
      <!-- 神级利爪手 -->
      <path class="hb-hand hb-hand-left" d="M16 128 Q 0 150, 10 174 Q 28 172, 48 158 Q 56 146, 50 130 Z" fill="#ff7b00" stroke="#ffd166" stroke-width="2"/>
      <path class="hb-hand hb-hand-right" d="M184 128 Q 200 150, 190 174 Q 172 172, 152 158 Q 144 146, 150 130 Z" fill="#ff7b00" stroke="#ffd166" stroke-width="2"/>
      <!-- 利爪脚 -->
      <path d="M62 184 Q 50 200, 72 202 Q 92 200, 88 184 Z" fill="#ff5e3a"/>
      <path d="M138 184 Q 150 200, 128 202 Q 108 200, 112 184 Z" fill="#ff5e3a"/>
      ${face}
    </g>
  </svg>`;
}

// 雅思页专用「小冰人」——外观是冰晶精灵，结构（hb-body / hb-eye / hb-hand）与火宝宝一致，
// 因此戳一戳的 wave / jump / spin / blink 动画与互动逻辑可完全复用。
function iceSvg() {
  return `<svg class="hb-ice" viewBox="0 0 100 120" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <defs>
      ...
      <radialGradient id="iceShine" cx="38%" cy="28%" r="62%">
    ...
    <g class="hb-body">
      <!-- 冰晶圆润身体 -->
      <path class="hb-ice-body" d="M50 18 C 70 40, 86 58, 80 84 C 76 106, 59 116, 50 116 C 41 116, 24 106, 20 84 C 14 58, 30 40, 50 18 Z" fill="url(#iceGrad)"/>
      <!-- 顶部小冰晶 -->
      <path d="M50 4 L55 13 L50 18 L45 13 Z" fill="#bae6fd"/>
      <!-- 光泽 -->
      <ellipse cx="40" cy="48" rx="21" ry="29" fill="url(#iceShine)"/>
      <!-- 左眼（眼白+瞳+高光） -->
      <g class="hb-eye hb-eye-l">
        <circle cx="38" cy="74" r="9.2" fill="#fff"/>
        <circle cx="40" cy="76" r="5.2" fill="#0c4a6e"/>
        <circle cx="37.4" cy="73.4" r="2.3" fill="#fff"/>
      </g>
      <!-- 右眼 -->
      <g class="hb-eye hb-eye-r">
        <circle cx="62" cy="74" r="9.2" fill="#fff"/>
        <circle cx="60" cy="76" r="5.2" fill="#0c4a6e"/>
        <circle cx="59.4" cy="73.4" r="2.3" fill="#fff"/>
      </g>
      <!-- 冰蓝腮红 -->
      <ellipse cx="27" cy="89" rx="5.6" ry="3.4" fill="#7dd3fc" opacity="0.55"/>
      <ellipse cx="73" cy="89" rx="5.6" ry="3.4" fill="#7dd3fc" opacity="0.55"/>
      <!-- 张嘴笑 + 冰蓝舌头 -->
      <path d="M42 90 Q50 101 58 90 Z" fill="#075985"/>
      <path d="M45 94 Q50 99 55 94 Z" fill="#67e8f9"/>
      <!-- 双手（小冰球） -->
      <circle class="hb-hand hb-hand-left" cx="15" cy="94" r="7.6" fill="#7dd3fc" stroke="#e0f7ff" stroke-width="2"/>
      <circle class="hb-hand hb-hand-right" cx="85" cy="94" r="7.6" fill="#7dd3fc" stroke="#e0f7ff" stroke-width="2"/>
    </g>
  </svg>`;
}
...
function buildHuobaoHtml(variant, ctx) {
  ...
  const mascot = isIce ? iceSvg() : flameSvg(lvl.lv);
