...
const IELTS_WRITING_PROMPTS = {
  "task1": [
    {
      "type": "折线图",
      "prompt": "The line graph below shows the number of visitors to three London museums (the British Museum, the Natural History Museum and the Science Museum) from 2007 to 2014.",
      "promptCn": "折线图：2007–2014 年伦敦三大博物馆的年度访客量。描述主要特征与趋势，约 150 词。",
      "tip": "第 1 段改写题目；Overview 段概括最显著趋势（谁最高/最低、整体上升）；再用两段对比具体数据并引用数字。",
      "sample": "The line graph illustrates the number of people who visited three major museums in London between 2007 and 2014.\n\nOverall, the British Museum was the most popular throughout the period, while the Science Museum attracted the fewest visitors, and all three showed a clear upward trend.\n\nIn 2007, the British Museum received about 5.5 million visitors, compared with 4.2 million at the Natural History Museum and only 2 million at the Science Museum. Over the next four years, the first two museums rose steadily, reaching 6.4 and 5 million respectively by 2011.\n\nFrom 2011 to 2014, the British Museum continued to climb, peaking at roughly 7.5 million, whereas the Natural History Museum fluctuated slightly before finishing at just under 5.5 million. The Science Museum, despite its low base, grew the fastest and ended at close to 4 million.\n\nIn summary, although the three museums grew at different rates, each became more popular over the eight-year period, reflecting a broader rise in cultural tourism."
    },
    {
      "type": "柱状图",
      "prompt": "The bar chart below shows the percentage of people in four age groups (15–24, 25–44, 45–64 and 65+) who used the internet daily in a European country in 2010 and 2020.",
      "promptCn": "柱状图：某欧洲国家四个年龄段人群在 2010 与 2020 年每日上网的比例。约 150 词。",
      "tip": "对比两个年份，突出差距最大与变化最明显的组别，注意用比较级与倍数表达。",
      "sample": "The bar chart compares the proportion of people in four age groups who went online every day in a European country in 2010 and 2020.\n\nOverall, daily internet use rose in all groups, and younger people remained the heaviest users, while the gap between the oldest and youngest groups narrowed over the decade.\n\nIn 2010, about 95% of 15–24-year-olds used the internet daily, and this figure stayed near 98% in 2020. The 25–44 group rose from 80% to 92%, while the 45–64 group climbed from 55% to 82%. These gains show steady adoption across working-age adults.\n\nThe most striking change was among over-65s, whose daily use jumped from only 20% to 60%. As a result, while the youngest group was roughly five times more likely to be online than the oldest in 2010, the difference narrowed to under two times by 2020.\n\nIn conclusion, internet use became nearly universal among the young and grew most rapidly among the elderly, reflecting broader digital adoption across every generation in society."
    },
    {
      "type": "饼图",
      "prompt": "The pie charts below compare the proportion of electricity generated from five sources (coal, natural gas, nuclear, wind and solar) in Country A and Country B in 2020.",
      "promptCn": "饼图：2020 年 A、B 两国五种发电方式的占比。约 150 词。",
      "tip": "先总览两国结构差异，再分别说明主导能源与清洁能源占比，用 account for / make up。",
      "sample": "The pie charts compare how electricity was generated from five sources in Country A and Country B in 2020.\n\nOverall, Country A relied heavily on fossil fuels, whereas Country B used a more balanced and cleaner mix, with a far larger share from renewables.\n\nIn Country A, coal accounted for the largest share at 45%, followed by natural gas at 30%. Nuclear provided 15%, while wind and solar together made up only 10%. This shows a strong dependence on carbon-intensive energy and limited investment in green alternatives.\n\nBy contrast, Country B produced 35% of its power from natural gas and 25% from nuclear. Renewables played a bigger role, with wind at 20% and solar at 15%, leaving coal at just 5%. The combined clean share was therefore close to 60%, more than twice that of Country A.\n\nIn summary, Country B was clearly ahead in adopting low-carbon sources, while Country A remained dominated by coal and gas, highlighting a significant gap in national energy structure."
    },
    {
      "type": "表格",
      "prompt": "The table below shows the average monthly household expenditure (in US dollars) on five categories in three cities in 2023.",
      "promptCn": "表格：2023 年三座城市家庭在五项上的月均支出（美元）。约 150 词。",
      "tip": "先概述总体水平差异，再挑选最高/最低项与最显著差异描述，不必罗列所有数字。",
      "sample": "The table shows average monthly household spending in five categories across three cities in 2023.\n\nOverall, City C was the most expensive, especially for housing, while City A had the lowest overall costs across every category surveyed.\n\nHousing was the largest item everywhere. City C spent 1,200 dollars, far above City B at 800 and City A at 550. Food costs were similar, ranging from 400 in City A to 520 in City C. Transport showed the widest gap after housing: City C (300) more than doubled City A (140), reflecting differences in commute patterns.\n\nLeisure and other expenses were relatively close, between 200 and 280 dollars. Notably, City A kept every category at the lowest level, suggesting a lower cost of living overall. City B sat in the middle on most items, while City C led on all except food, where it was narrowly behind.\n\nIn conclusion, the data indicates that housing drove most of the difference in living costs between the three cities, with City C the priciest overall."
    },
    {
      "type": "流程图",
      "prompt": "The diagram below illustrates the process by which recycled paper is manufactured in a recycling plant.",
      "promptCn": "流程图：某回收厂将废纸再造成再生纸的过程。约 150 词。",
      "tip": "用被动语态按时间顺序描述各阶段，使用 first, then, after that, finally 等连接词。",
      "sample": "The diagram explains how waste paper is recycled into new paper at a treatment plant.\n\nOverall, the process consists of several stages, from collecting used paper to producing finished rolls, and is largely mechanical rather than manual.\n\nFirst, discarded paper is sorted and cleaned to remove staples and dirt. It is then shredded into small pieces and mixed with water to form a pulp. Next, the pulp passes through a filter that eliminates ink and glue, after which it is washed again to improve purity before further treatment.\n\nThe cleaned pulp is spread onto a flat screen, pressed to remove excess water, and passed through heated rollers that dry it into continuous sheets. Finally, the dry paper is rolled up and sent to factories for use. No stage requires direct human handling of the final product.\n\nIn summary, the production of recycled paper is a multi-stage, automated process that turns waste material into a reusable product while reducing environmental impact."
    },
    {
      "type": "地图",
      "prompt": "The maps below show the changes that took place in the town of Ashford between 1995 and 2025.",
      "promptCn": "地图：Ashford 镇在 1995 与 2025 年之间的变化。约 150 词。",
      "tip": "对比两幅图，描述新增/消失的地物（道路、建筑、绿地），用方位词与 there be 句型。",
      "sample": "The maps illustrate how the town of Ashford changed between 1995 and 2025.\n\nOverall, the town expanded considerably, with new transport links and residential areas replacing much of the open land that once surrounded it.\n\nIn 1995, Ashford was small, with a river separating the town centre from a few houses and a single railway line to the north. By 2025, a second railway station and a motorway had been built, greatly improving connectivity with nearby cities and reducing travel time.\n\nThe most noticeable change was the construction of a large housing estate and a business park on the eastern side. The original forest in the south was partly cut down to make room for a golf course, while a school and a hospital appeared near the centre. The river remained, but a new bridge connected both banks.\n\nIn conclusion, Ashford transformed from a quiet town into a more developed and connected community, though some green space was lost in the process of growth."
    }
  ],
  "task2": [
    {
      "type": "讨论型",
      "prompt": "Some people think that universities should focus on providing academic skills, while others believe they should prepare students with practical skills for the workplace. Discuss both views and give your own opinion.",
      "promptCn": "讨论型：大学应侧重学术能力还是职场实用技能？讨论双方并给出你的观点。",
      "tip": "两段分别呈现两方理由，结尾明确你的立场并简要论证（可折中）。",
      "sample": "Universities have long been the subject of debate: should they focus on academic scholarship or on practical, work-ready skills? This essay will examine both perspectives before presenting my own view.\n\nOn the one hand, supporters of a traditional academic focus argue that universities exist to cultivate critical thinking and deep, transferable knowledge. Subjects such as philosophy, history and pure mathematics train the mind in ways that remain valuable throughout a person's life, whatever career they later choose. They believe that a broad, rigorous intellect — rather than a narrow set of technical routines — is the true purpose of higher education, and that genuine employability naturally follows from an adaptable, well-trained mind.\n\nOn the other hand, an increasing number of people contend that graduates enter a highly competitive world and must be productive immediately. They point out that practical training, such as internships, coding courses and laboratory placements, allows students to contribute to the economy without a long period of further on-the-job learning. From this perspective, universities owe both students and taxpayers a clear, measurable return in the form of job-ready graduates who can fill pressing shortages in health, engineering and technology.\n\nIn my opinion, the two aims are not mutually exclusive, and a false choice between them wastes talent. A balanced curriculum that develops both rigorous analysis and applicable skills serves students best. I therefore believe universities should embed practical experience — through project-based learning, clinics and industry placements — within an academically sound framework. Such an approach not only deepens understanding but also reassures employers that new graduates can perform from day one, and it eases the difficult transition into the workforce.\n\nIn conclusion, while both sides raise valid points, a hybrid model that blends scholarship with practical training is the most sensible path forward for modern universities."
    },
    {
      "type": "观点型",
      "prompt": "In many countries, an increasing number of people are choosing to live alone. Is this a positive or negative development?",
      "promptCn": "观点型：越来越多人选择独居，这是积极还是消极的发展趋势？",
      "tip": "明确立场（积极/消极/中立），主体段各给一个理由 + 例子，结尾收束。",
      "sample": "The rise of one-person households is a striking social trend in many nations, and it raises the question of whether this shift is beneficial or harmful. I believe it is largely a positive development, though it is not without drawbacks.\n\nOne clear benefit is personal freedom. People who live alone can arrange their time, decorate their space and make daily decisions without compromise or negotiation. For young professionals in particular, this independence often builds confidence and self-reliance that serve them well later in life, as they learn to manage budgets, chores and responsibilities entirely on their own.\n\nMoreover, living alone can improve well-being when it is a free choice. A person recovering from a difficult relationship, for example, may find peace and restoration in a private home where they control their own environment. In cities where housing is scarce, smaller units designed for singles also make more efficient use of land, energy and water than large family houses, easing pressure on limited resources.\n\nHowever, critics rightly note the loss of daily community and the risk of loneliness, especially among the elderly who may lack regular contact with others. These concerns are valid and call for stronger social support, such as community centres, neighbour networks and routine check-ins by local services.\n\nFurthermore, the trend reflects broader social change, including later marriage and greater mobility, so it is unlikely to reverse soon. Societies that welcome this shift, rather than lament it, can redesign housing, services and urban life to suit one-person households.\n\nIn conclusion, while isolation is a genuine risk, the autonomy and self-knowledge that living alone provides make it, on balance, a positive change for those who choose it."
    },
    {
      "type": "讨论型",
      "prompt": "Some people believe children should start school as early as possible, while others think they should begin only when they are older. Discuss both views and give your opinion.",
      "promptCn": "讨论型：孩子应尽早入学还是稍大些再入学？讨论双方并给出观点。",
      "tip": "一方强调早学的语言/作息优势，另一方强调游戏与身心健康，结尾给折中立场。",
      "sample": "When children should begin formal schooling is a question that divides parents, teachers and policymakers alike. This essay will discuss both sides before offering a view.\n\nThose in favour of an early start argue that young brains absorb language, routine and social skills most easily. Kindergarten at age three or four, they say, builds foundations for learning and gives working parents vital support. Early exposure, in their view, creates a head start that lasts for years and helps children adapt smoothly to structured environments later on.\n\nOpponents counter that pushing academic work too soon can harm development. They claim that young children need free play to build creativity, curiosity and emotional health, and that formal pressure at a tender age can cause anxiety and resentment towards school. In their experience, a later start at six or seven produces happier, better-adjusted learners who are mentally ready to concentrate.\n\nI take a moderate position. Structured learning is valuable, but in the early years it should be gentle, play-based and child-centred rather than rigid drill. Therefore, I believe a flexible entry age that respects each child's maturity and home context is wiser than a single rule imposed by the state for everyone.\n\nIt is also worth noting that the best starting age varies between children: some are ready at five, others not until seven. A rigid national rule ignores this natural variation and can disadvantage children at either extreme of the spectrum.\n\nIn conclusion, both timing choices have real merits, yet a balanced, developmentally appropriate approach serves children best."
    },
    {
      "type": "利弊型",
      "prompt": "Some people think that using computers and the internet in education brings more benefits than drawbacks. To what extent do you agree or disagree?",
      "promptCn": "利弊/观点型：计算机与网络用于教育是利大于弊吗？",
      "tip": "可写成利弊对比，结尾给出平衡判断（利大于弊，但需引导）。",
      "sample": "Technology has reshaped classrooms around the world, and many argue that its benefits for education outweigh the drawbacks. I largely agree, provided that it is used with care and clear boundaries.\n\nThe advantages are substantial. Online resources give students instant access to knowledge far beyond any textbook, while interactive tools, videos and simulations make difficult concepts easier to grasp. For learners in remote or underfunded areas, the internet can compensate for a shortage of local teachers, narrowing educational inequality and opening global perspectives that were once impossible.\n\nNevertheless, real drawbacks exist. Excessive screen time can shorten attention spans and discourage deep reading. Not every family can afford devices or reliable connections, which risks widening the gap between rich and poor. Over-reliance on technology may also weaken basic skills such as handwriting, mental arithmetic and face-to-face communication, leaving students dependent on machines.\n\nIn my view, the positives dominate if schools set firm rules and train teachers to blend old and new methods. A thoughtful mix of digital tools with traditional teaching captures the best of both worlds and prepares students for a digital economy without sacrificing fundamentals.\n\nCrucially, teachers remain essential to guide, motivate and assess learning; technology extends their reach rather than replacing their judgement. Schools that train staff to use it well see the greatest gains in both engagement and results, and equal access to devices must be guaranteed so that no student is left behind by the digital divide.\n\nIn conclusion, computers and the internet are powerful educational aids whose benefits exceed their risks when guided by good pedagogy and equitable access."
    },
    {
      "type": "问题解决型",
      "prompt": "Many cities face severe traffic congestion. What are the causes of this problem, and what measures could governments take to solve it?",
      "promptCn": "问题解决型：城市交通拥堵的成因与对策。",
      "tip": "一段写原因（私家车增多、规划失衡、公交不足），一段写对策（公交投资、拥堵费、远程办公）。",
      "sample": "Traffic congestion has become a daily frustration in cities across the globe, harming productivity, air quality and quality of life. This essay examines the causes and proposes practical solutions.\n\nThe main driver is the surge in private car ownership, as rising incomes allow more families to buy vehicles. Poor urban planning makes this worse: many cities concentrate offices and shops in central areas while housing sprawls outward, forcing long commutes. Where public transport is slow, infrequent or expensive, people have little choice but to drive, which compounds congestion during peak hours.\n\nTo address this, governments should invest heavily in mass transit, making buses, trains and metros cheaper, cleaner and more reliable than driving. Congestion charges, already used successfully in London and Singapore, discourage unnecessary trips and raise funds for further improvements. Encouraging remote work and flexible hours can also thin traffic during rush periods.\n\nIn addition, building protected bike lanes and pedestrian zones reduces short car journeys in dense neighbourhoods, while Park-and-Ride schemes link suburbs to transit. Without coordinated action, however, the problem will only intensify as populations and car numbers keep growing.\n\nThis mismatch between where people live and where they work lies at the heart of the problem, and no single measure will solve it alone. Only a coordinated package of transit, pricing and planning, sustained over years, can reverse the decline in urban mobility.\n\nIn conclusion, while car growth and weak planning cause congestion, a mix of better transit, smart pricing and flexible work can meaningfully ease it."
    },
    {
      "type": "讨论型",
      "prompt": "Some people say advertising encourages us to buy things we do not need, while others believe it provides useful information. Discuss both views and give your opinion.",
      "promptCn": "讨论型：广告是诱导消费还是提供有用信息？讨论双方并给观点。",
      "tip": "一方谈操纵欲望/债务，一方谈信息透明/助小企业，结尾给平衡判断。",
      "sample": "Advertising surrounds us in every medium, and opinions about its effects are sharply divided. This essay will consider both arguments before giving a view.\n\nCritics claim that advertising manipulates desire. By linking products to status, beauty or happiness, ads push people to buy what they neither need nor can afford, fuelling debt, clutter and waste. Children are seen as especially vulnerable to such persuasion, and constant exposure may distort their sense of what is truly valuable in life.\n\nSupporters, however, point out that advertising also informs. It tells consumers about new products, compares prices and helps small firms reach customers who would otherwise never hear of them. Without advertising, many useful innovations would stay unknown, and competition between brands — which drives quality up and prices down — would weaken considerably.\n\nI believe the truth lies between these positions. Advertising is valuable when it is truthful and relevant, yet harmful when it is deceptive, intrusive or aimed at the young. Strong rules on honesty, clearer labelling and limits on marketing to children, I think, allow its benefits to remain while curbing its excesses and protecting the vulnerable.\n\nBoth sides raise points that any honest assessment must take seriously, and the right balance differs by context. What suits everyday consumer goods may be inappropriate for sensitive products such as alcohol, gambling or unhealthy food, so reasonable safeguards rather than outright bans are the soundest approach.\n\nIn conclusion, advertising is a double-edged tool whose impact depends on how truthfully and responsibly it is practised."
    },
    {
      "type": "观点型",
      "prompt": "It is better for children to grow up in the countryside than in a big city. To what extent do you agree or disagree?",
      "promptCn": "观点型：孩子在乡村长大是否优于大城市？",
      "tip": "明确立场，分别用乡村/城市的利弊支撑，结尾强调教养质量比地点更重要。",
      "sample": "Whether children thrive more in the countryside or in a big city is a matter of ongoing debate. I partly disagree with the claim that rural life is clearly better, because both settings offer distinct advantages.\n\nThe countryside can be ideal for childhood. Clean air, open spaces and close-knit communities let children play freely, stay active and feel safe. With fewer distractions and less noise, they may also concentrate better on study and family time, and they often form stronger bonds with neighbours and relatives than city children typically do.\n\nCities, however, provide superior schools, libraries, museums and extracurricular programmes that broaden young minds. Exposure to diverse cultures and people builds tolerance and confidence, while better healthcare adds an important margin of safety. For ambitious or disadvantaged families, these resources — hard to match in villages where opportunities can be limited — can be decisive for a child's future.\n\nIn my view, the quality of parenting, schooling and community matters far more than the location itself. A loving, stimulating home nurtures a child anywhere, and modern technology now brings decent education even to remote villages through online learning.\n\nWhat matters most is a stable, loving environment, which either setting can provide with the right family. Policy should therefore support parents wherever they live, rather than assuming one location guarantees a better childhood, because love and stability outperform postcodes in raising happy children.\n\nIn conclusion, while the countryside has genuine appeal, cities offer opportunities that make neither setting clearly superior, and the best choice depends on the particular family."
    },
    {
      "type": "利弊型",
      "prompt": "In many countries, people are working longer hours than before. What are the advantages and disadvantages of this trend?",
      "promptCn": "利弊型：人们工作时间变长，利弊如何？",
      "tip": "各写一段利弊，结尾权衡（短期收益 vs 身心/社会成本）。",
      "sample": "Longer working hours have become common in many economies, as companies demand more output and living costs rise. This essay weighs the benefits of this trend against its costs.\n\nOn the positive side, extra hours can raise incomes and help workers cope with rising living costs, from rent to education. For employers, a longer roster may lift productivity and meet tight deadlines without the expense of hiring more staff. Ambitious employees may also gain faster promotion and stronger job security as a direct result of their greater commitment to the firm.\n\nThe downsides, however, are serious. Prolonged work erodes family time, sleep and health, raising rates of stress and burnout among the workforce. Fatigue lowers concentration and increases mistakes, ultimately hurting the very output it was meant to raise. Societies that overwork also see weaker communities and higher long-term healthcare costs.\n\nOn balance, I believe the disadvantages outweigh the advantages unless the extra hours are truly voluntary, fairly paid and accompanied by adequate rest. Sustainable schedules protect both people and performance, and flexible or compressed arrangements can meet business needs without exhausting staff.\n\nHealthy limits ultimately serve both workers and employers in the long run, because exhausted staff are neither productive nor loyal. Cultures that normalise restraint, not endless hours, tend to retain talent and sustain performance far better, and sustainable hours are paradoxically the faster route to lasting results, benefiting everyone involved.\n\nIn conclusion, while longer hours bring short-term gains, their personal and social costs make moderation the wiser long-term choice."
    }
  ]
};
